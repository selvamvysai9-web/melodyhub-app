                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Join Melody Hub and start vibing',
                              style: TextStyle(
                                fontSize: 13,
  ...
  Widget _buildHeader() {
    return Column(
      children: [
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [
                ...
                AuroraTheme.accentPink.withValues(alpha: 0.5),
              ],
            ),
            boxShadow: [
              BoxShadow(
                color: AuroraTheme.accentPurple.withValues(alpha: 0.25),
                blurRadius: 30,
                spreadRadius: 2,
              ),
            ],
        ...
        ShaderMask(
          shaderCallback: (bounds) => const LinearGradient(
            colors: [AuroraTheme.accentPurple, AuroraTheme.accentPink],
          ).createShader(bounds),
          child: const Text(
            'Melody Hub',
            style: TextStyle(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      AuroraTheme.accentPurple.withValues(alpha: 0.15),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      AuroraTheme.accentPink.withValues(alpha: 0.12),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      AuroraTheme.accentCyan.withValues(alpha: 0.06 + t * 0.04),
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide:
              const BorderSide(color: AuroraTheme.accentPurple, width: 1.5),
        ),
  ...
  Widget _buildPrimaryButton({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AuroraTheme.accentPurple.withValues(alpha: 0.3),
            blurRadius: 16,
  ...
  Widget _buildOutlineButton({
    ...
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        onPressed: onPressed,
        icon: Icon(icon, size: 20, color: AuroraTheme.accentPurple),
        label: Text(
          label,
          style: const TextStyle(
        ...
        style: OutlinedButton.styleFrom(
          side: BorderSide(
              color: AuroraTheme.accentPurple.withValues(alpha: 0.4)),
          shape:
              RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
          backgroundColor:
              AuroraTheme.accentPurple.withValues(alpha: 0.06),
        ),
      ),
    );
  }
